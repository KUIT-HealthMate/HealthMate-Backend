...
public class GptMonthResult {
    ...
    @Builder
    public GptMonthResult(Long userId, Long month, LifeStyleResponse lifeStyleToday, MealPatternResponse mealPatternToday, SleepPatternResponse sleepPatternToday){
        this.userId = userId;
        this.month = month;
