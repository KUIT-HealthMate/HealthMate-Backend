...
public enum ExceptionResponseStatus {
    ...
    INVALID_DATE_FORMAT(2003,HttpStatus.BAD_REQUEST.value(), "유효하지 않은 날짜 포맷 입니다."),
    /**
     * 3000: Habit 오류
     */
    ...
    /**
     * 7000: DIAGNOSIS 관련 오류
     */
    INVALID_DIAGNOSIS_VALUE(7001, HttpStatus.BAD_REQUEST.value(), "요청에서 잘못된 값이 존재합니다.");
