...
public class LifeStyleMonthFormatter {
    ...
    private String formatResponse(List<LifeStyleQuestionnaire> dto, String userName,List<SymptomQuestionnaire> symptoms) {
        ...
        response.append("한달동안 위의 문항에서 각각 ");
        ...
        response.append("응답을 예시와 같은 Json 포맷으로 반환해줘, 백틱은 제외하고 순수하게 json 값만 보내, 키값도 아래 형식이랑 유지해줘\n");
