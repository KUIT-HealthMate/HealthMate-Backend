...
public class SupplementService {
    ...
    public List<Supplement> getSupplementEditList(Long userId) {
        return supplementRepository.findAllWithTimesByActiveAndUserId(userId);
    }

    public List<Supplement> getSupplementForToday(Long userId, LocalDate date) {
        List<Supplement> supplements =  supplementRepository.findAllActiveByUserIdForToday(userId, date, date.getDayOfWeek().getValue());
